import { NavLink, useLocation, Link as AnchorLink } from "react-router-dom";
    ...
    <>
      <header>
        ...
        <div className='h-14 w-full flex border-b z-50 px-5'>
          ...
          <Link
            to='https://anakin-dabir.github.io/public/resume.pdf'
            className='hidden md:flex focus:text-textInactive hover:!text-textActive'
            name='resume'
            target='_blank'
          />
...
export const Link = ({ to = "/", name, className, target }) => {
        ...
        <div className='flex flex-col text-2xl justify-center items-end flex-1 transition-opacity gap-1'>
          ...
          <div className='h-14  box-center'>
            <Link
              to='https://anakin-dabir.github.io/public/resume.pdf'
              name='resume'
              className='focus:!text-textInactive hover:!text-textActive'
              target='_blank'
            />
          </div>
          <div className='h-14  box-center'>
