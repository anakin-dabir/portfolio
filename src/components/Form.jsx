...
const Form = () => {
  ...
  const handleChange = e => {
    ...
    if (name === "name") {
      ...
      if (emailRegex.test(value) && !stringFilter.test(value))
      ...
      <div className={"box-center w-full flex-col text-textInactive caret-primary h-full"}>
        ...
        >
          ...
          <button
            ...
            } box-center border-2 border-dashed border-borderColor -mb-2 rounded-full p-3 w-32 self-start hover:bg-borderColor hover:text-textActive focus:bg-borderColor transition-colors active:scale-95`}
          >
            Send
          </button>
        </form>
