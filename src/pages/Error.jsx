...
const Error = () => {
  return (
    <div className="gap-8 h-64 w-64 box-center flex-col mt-14 md:mt-0 top-1/2 left-1/2 fixed -translate-x-1/2 -translate-y-1/2">
      ...
      <Link to="/">
        <div className="flex items-center gap-4 border-b-4 border-textInactive hover:border-textActive hover:scale-110 transition-all">
          <svg
            className="h-10 w-10 fill-textInactive hover:fill-textActive"
            version="1.1"
            id="Capa_1"
