			...
			<div className='h-full w-full flex-1 flex overflow-hidden items-center justify-center 2xl:gap-32 gap-10 px-5 py-5 relative'>
				...
				<div className='flex flex-col gap-8'>
					<div className='flex flex-col gap-2'>
						...
						<p className='text-5xl md:text-6xl'>Saturo Gojo</p>
						<p className='text-primary text-xl md:text-3xl'>
							<span className=''>{'->'}</span>
							<Typewriter cursorStyle={'_'} typeSpeed={100} cursorColor='#43D9AD' loop cursor words={[' Full Stack Engineer', ' React Developer']} />
						</p>
					</div>
					<div className='flex flex-col'>
						...
						<p>
							...
							<span> = </span>
							<span className='text-secondary'>"https://github.com/anakin-dabir"</span>
						</p>
					</div>
				</div>
				<Game />
