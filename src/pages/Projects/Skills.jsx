...
const Skills = ({ height }) => {
	return (
		<div style={{ height: height }} className={`overflow-y-auto`}>
	...
	return (
		<>
			<a href={to} className='box-center group relative' target='_blank' rel='noopener noreferrer'>
				<div className='bg-black border border-borderColor h-5 opacity-0 box-center transition-opacity group-focus:opacity-100 text-textInactive absolute top-0 right-0 group-hover:opacity-100'>
					{name}
				</div>
				{children}
			</a>
