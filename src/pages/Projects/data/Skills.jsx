import { CssIcon, DockerIcon, FigmaIcon, HtmlIcon, ReactIcon } from "../icons/IconPack1";
import { ExpressIcon, JsIcon, MongoIcon, TsIcon } from "../icons/IconPack2";
import { MuiIcon, NextIcon, ReduxIcon, SocketIcon, TailwindIcon } from "../icons/IconPack3";
...
const Skills = () => {
  return (
    <div className="box-center flex-wrap p-4 h-full gap-5">
      ...
      <SvgLink to="https://docs.docker.com" name="Docker">
        <DockerIcon />
      </SvgLink>
    </div>
  );
